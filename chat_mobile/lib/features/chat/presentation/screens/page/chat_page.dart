            ...
            child:  BlocListener<ChatBloc, ChatState>(
              listener: (context, state) {
                if (state is NewMessageReceivedState) {
                  debugPrint('New message received in chat ${state.message.chat?.id}');
                  setState(() {
                ...
                if (state is NewSuggestionsState) {
                    setState(() {
                ...
                if (state is NewReadReceiptState) {
                  debugPrint('🪂🪂New read receipt for message ID: ${state.readReceipts}');
                        ...
                        isSentByUser
                            ...
                            : VisibilityDetector(
                                ...
                                onVisibilityChanged: (VisibilityInfo info) {
                                  ...
                                  debugPrint('VisibilityDetector for message ID: ${message.id}');
